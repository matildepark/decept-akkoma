<template>
  <div class="panel panel-default base01-background">
    ...
    <div class="panel-body terms-body">
      <p>
        Reciprocal Technologies, Ltd. ("we", "us", "our", "Reciprocal") present the
        following terms and conditions, which govern your use of the decept.org
      ...
      <p>
        ...
        this Website by us (collectively, the Agreement).
      </p>
      ...
      <p>
        ...
        conditions are considered an offer by Reciprocal, acceptance is
        expressly limited to these terms. The Website is available only to
        individuals who are at least 13 years old.
      </p>

      <p>
        If you operate an account, comment on an account, post material to
        ...
        graphics, an audio file, a video file, or computer software.
      </p>
      ...
      <p>
        Payments to Reciprocal, for account services or for any other
        purpose, are refundable or transferable solely at Reciprocal's
        discretion.
      </p>

      <p>
        By using this Service, you agree to this account structure, and to
        Reciprocal's right to change, modify, or discontinue any type
        of account or the features available to it at any time.
      </p>

      <h3>III. Indemnity</h3>

      <p>
        You agree to indemnify and hold harmless Reciprocal Technologies, Ltd, its
        ...
        including but not limited to out of your violation of this Agreement.
      </p>
      ...
      <p>
        If you wish to terminate this Agreement, you may delete your account
        ...
        provided, at any time past the deletion of your account.
      </p>

      <p>
        Paid accounts that are terminated for violations of this Agreement will
        only be refunded at our discretion, and only if such termination should
        come under our established criteria for issuing refunds.
      </p>
      ...
      <h3>V. License to Reproduce Content</h3>

      <p>
        By submitting Content to us for inclusion on the Website, you grant
        ...
        including through downloadable clients and external feeds.
      </p>

      <p>
        If you delete Content, we will use reasonable efforts to remove it
        from the Website, but you acknowledge that caching or references to the
        Content may not be made immediately unavailable, and in some cases may
        not be removable at all from distribution to other servers outside our control.
      </p>

      <h3>VI. Account Content</h3>
      ...
      <p>
        ...
        posting of any Content that you do not have the rights to post.
      </p>

      <p>
        2. All Content posted to the Website in any way is the responsibility
      ...
      <p>
        3. We do not pre-screen Content. However, you acknowledge that we
      ...
      <p>
        4. If any Content you have submitted is reported to us as violating
      ...
      <h3>VII. Content Posted on Other Websites</h3>
      ...
      <p>
        ...
        us or by any provider of Content on the Website.
      </p>

      <p>
        Likewise we have not reviewed and cannot review material made available
        through syndication from other servers.
      </p>

      <h3>VIII. No Resale of Services</h3>
      ...
      <h3>IX. Exposure to Content</h3>

      <p>
        You agree that by using the service, you may be exposed to Content
      ...
      <p>
        2. Upload, post, or otherwise transmit any Content that is spam, or
      ...
      <p>
        3. Maliciously impersonate any real person or entity, including but not limited to a
        Decept.org staff member or volunteer, or to otherwise misrepresent your
        affiliation with any person or entity;
      </p>

      <p>
        4. Upload, post or otherwise transmit any Content that you do not
      ...
      <p>
        5. Upload, post or otherwise transmit any Content that infringes any
        patent, trademark, trade secret, copyright, or other proprietary rights
        of any party;
      </p>

      <p>
        6. Interfere with or disrupt the Website or servers or networks
      ...
      <p>
        7. Solicit passwords or personal identifying information for
      ...
      <p>
        9. Upload, post or otherwise transmit any Content that contains
        viruses, worms, malware, Trojan horses or other harmful or destructive
        content;
      </p>

      <p>
        10. Allow usage by others in such a way as to violate this
        Agreement;
      </p>

      <p>
        11. Make excessive or otherwise harmful automated use of the
        Website;
      </p>

      <p>
        12. Access any other person's account, or exceed the scope of the
        Website that you have signed up for; for example, accessing and using
        features you don't have a right to use.
      </p>

      <h3>XI. Copyright Infringement</h3>

      <p>
        If you believe that material located on the Website violates your
        copyright, you may <a href="https://reciprocal.ltd">notify us</a>.
        We will respond to all such notices as
      ...
      <h3>XIV. Disclaimer of Warranties</h3>

      <p>
        <strong>This Website is provided "as is". Reciprocal Technologies, Ltd and its
          suppliers and licensors hereby disclaim all warranties of any kind,
          express or implied, including, without limitation, the warranties of
          merchantability, fitness for a particular purpose and non-infringement.
          Neither Reciprocal Technologies, Ltd, nor its suppliers and licensors, makes
          ...
          your own discretion and risk.</strong>
      </p>

      <p>
        <strong>No advice or information, whether oral or written, obtained by you
          in any fashion shall create any warranty not expressly stated in this
          Agreement.</strong>
      </p>

      <h3>XV. Limitation of Liability</h3>

      <p>
        <strong>You expressly understand and agree that in no event will
          Reciprocal Technologies, Ltd., or its suppliers or licensors, be liable with
          ...
          or delay due to matters beyond our reasonable control. </strong>
      </p>

      <p>
        <strong>The foregoing shall not apply to the extent prohibited by
          applicable law.</strong>
      </p>

      <h3>XVI. General Information</h3>
      ...
      <p>
        ...
        Reciprocal Technologies, Ltd, or by the posting of a revised version to this
        location. Except to the extent that applicable law (if any) provides
        otherwise, any dispute arising between you and Reciprocal Technologies Ltd
        ...
        excluding any conflict of law provisions. You agree to
        submit to the jurisdiction of the provincial and federal courts located in
        British Columbia for any disputes arising out of or relating to
        your use of the Website or your acceptance of this Agreement.
      </p>
